export const mockCard = {
  ...
  main_picture: {
    medium: 'https://cdn.myanimelist.net/images/anime/12/26966.jpg',
    large: 'https://cdn.myanimelist.net/images/anime/12/26966l.jpg',
  },
  alternative_titles: {
    synonyms: [
    ...
    en: 'Gintama: Shinyaku Benizakura-hen EN',
    ja: '銀魂 新訳紅桜篇',
  },
  mean: 8.28,
